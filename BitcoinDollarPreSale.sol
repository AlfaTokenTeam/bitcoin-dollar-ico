...
import "./BitcoinDollar.sol";

contract BitcoinDollarPreSale {
    BitcoinDollar public token;
    ...
    function BitcoinDollarPreSale(
        BitcoinDollar _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = BitcoinDollar(_token);
